<!-- Footer -->
<footer 
class="d-print-none text-center text-lg-start text-white pt-3"
...
<div class="col-md-3 col-lg-2 col-xl-2 mx-auto mt-3">
  ...
  <p>
    <span class="text-white">Termes of services</span>
  </p>
  <p>
...
<div class="col-md-3 col-lg-2 col-xl-2 mx-auto mt-3">
  ...
  <p>
    <span class="text-white">Go2Trip for android</span>
  </p>
  <p>
    <span class="text-white">Go2Trip for ios</span>
  </p>
  <p>
